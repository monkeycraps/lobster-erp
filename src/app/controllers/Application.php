...
class ApplicationController extends Yaf\Controller_Abstract {
	...
	function isAjax(){
		return (isset ( $_SERVER ['HTTP_X_REQUESTED'] ) && $_SERVER ['HTTP_X_REQUESTED'] === 'JSON') || (isset ( $_GET ['_X_REQUESTED_'] ) && $_GET ['_X_REQUESTED_'] == 'JSON') || strtolower($_SERVER['CONTENT_TYPE']) == 'application/json' || isset( $_SERVER['HTTP_X_REQUESTED_WITH'] );
	}
}
