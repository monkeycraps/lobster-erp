define("jquery-plugin/bootstrap-datepicker/1.1.3/datepicker-debug", [ "$-debug", "./i18n/{locale}-debug" ], function(require) {
    ...
    (function($) {
        ...
        Datepicker.prototype = {
            ...
            _process_options: function(opts) {
                ...
                if (!dates[lang]) {
                    lang = lang.split("-")[0];
                    if (!dates[lang]) lang = $.fn.datepicker.defaults.language;
                }
                o.language = lang;
                switch (o.startView) {
                  case 2:
        ...
        $.fn.datepicker = function(option) {
            ...
            this.each(function() {
                ...
                if (!data) {
                    ...
                    xopts = $.extend({}, $.fn.datepicker.defaults, elopts, options), locopts = opts_from_locale(xopts.language), // Options priority: js args, data-attrs, locales, defaults
        ...
        $.fn.datepicker.locale_opts = [ "format", "rtl", "weekStart" ];
